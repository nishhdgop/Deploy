...
document.querySelector("form").addEventListener("submit", async (e) => {
  ...
  const greeting = await _declarations_hello_backend__WEBPACK_IMPORTED_MODULE_0__.hello_backend.greet();
  const something = await _declarations_hello_backend__WEBPACK_IMPORTED_MODULE_0__.hello_backend.inc();
